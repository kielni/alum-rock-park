...
elevation_utm = Layer(
    ...
    processing_step=ProcessingStep(
        description=(
            "Reproject the USGS elevation raster from NAD83 geographic (EPSG:4269)"
            " to UTM zone 10N (EPSG:26910) so horizontal and vertical units match for"
            " slope calculation."
        ),
        algorithm=(
            "gdalwarp -t_srs EPSG:26910 -r bilinear ./data/USGS_elevation.tif {output}"
        ),
        depends_on=[],
